...
__all__ = ['autohotkeyLexer', 'CLexer', 'CppLexer', 'DLexer', 'DelphiLexer', 'JavaLexer', 'ScalaLexer',
...
class CLexer(RegexLexer):
    ...
    tokens = {
        ...
        'statements': [
            ...
            ('[a-zA-Z_][a-zA-Z0-9_]*:{1,2}', Name.Label),
...
# run the  _mapping.py file after any change here
